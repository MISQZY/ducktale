...
export default async function AdminLoading() {
  ...
  const activeTab = "applications" === "roles" ? "role" : "applications";

  return (
    <AdminPageShell title={t("navApplications")} description="..." active={activeTab as Resource} navAccess={navAccess}>
