...
export default async function AdminLoading() {
  ...
  const activeTab = "resource-roles" === "roles" ? "role" : "resource-roles";

  return (
    <AdminPageShell title={t("navResourceRoles")} description="..." active={activeTab as Resource} navAccess={navAccess}>
