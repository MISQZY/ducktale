    ...
    <>
      ...
      <main className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-16">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          <StatusBadge label={t("badge")} className="mb-8" />
              ...
              {SERVERS.map((server) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-muted border border-border/60 flex items-center justify-center text-lg
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-foreground/30 text-xs">{tServers(`items.${server.id}.tagline`)}</div>
                    </div>
                  </div>
                  <ArrowRight
                    size={13}
