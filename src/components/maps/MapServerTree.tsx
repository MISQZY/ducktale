...
export function MapServerTree({ lang, servers, noMapsLabel }: MapServerTreeProps) {
  ...
  return (
    <aside className="w-full h-full flex flex-col min-w-0 overflow-hidden overflow-y-auto custom-scrollbar rounded-2xl border border-primary/20 bg-card/50 p-3">
