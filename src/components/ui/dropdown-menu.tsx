...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-xs font-medium text-foreground/50 uppercase tracking-widest data-[inset]:pl-8",
        className
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("-mx-1.5 my-1.5 h-px bg-primary/10", className)}
      {...props}
    />
  )
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn("ml-auto text-xs tracking-widest text-foreground/40", className)}
      {...props}
    />
  )
}
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "focus:bg-primary/10 focus:text-primary",
        "data-open:bg-primary/10 data-open:text-primary",
        "data-[inset]:pl-8",
        className
      )}
      {...props}
