...
const ADMIN_PAGE_RESOURCES: Resource[] = ["users", "whitelist", "content", "tickets", "badges", "ranks", "role", "row-level-roles", "resource-roles", "maps", "events", "news", "reports", "applications", "workflows"];
